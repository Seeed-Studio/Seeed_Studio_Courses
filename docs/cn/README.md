...
| ✅ 09 | [OpenCV 基础操作](../../docs/cn/2/09/README.md) | 学会图像缩放、旋转、裁剪等基本操作，应用滤波器处理图像。 | ✅ [视频链接](https://www.bilibili.com/video/BV1aiKAeqER5) |
| ✅ 10 | [OpenCV 视频流处理](../../docs/cn/2/10/README.md) | 理解视频流概念，实现视频捕获与实时视频处理。 | ✅ [视频链接](https://www.bilibili.com/video/BV1qZ9uYYEdt) |
| ✅ 11 | [边缘检测与形态学操作](../../docs/cn/2/11/README.md) | 使用 Canny 算法进行边缘检测，掌握形态学操作（腐蚀、膨胀）。 | ✅ [视频链接](https://www.bilibili.com/video/BV144RnY7ERF) |
| ✅ 12 | [轮廓检测与特征提取](../../docs/cn/2/12/README.md) | 学习轮廓检测与特征匹配，进行图像配准。 | ✅ [视频链接](https://www.bilibili.com/video/BV11DXrYeEk7) |
| ✅ 13 | [人脸检测基础](../../docs/cn/2/13/README.md) | 了解人脸检测原理，使用 OpenCV 实现人脸检测。 | ✅ [视频链接](https://www.bilibili.com/video/BV1yEdnY2EsB) |
| ✅ 14 | [计算机视觉实践项目](../../docs/cn/2/14/README.md) | 完成计算机视觉小项目，培养团队协作与实践能力。 | ✅ [视频链接](https://www.bilibili.com/video/BV1Mm5yzFEaF) |
| **三、深度学习与边缘 AI** | | | |
| ✅ 15 | [深度学习概述与数据准备](../../docs/cn/3/15/README.md)| 理解深度学习基本概念、神经网络结构与边缘计算应用；掌握数据收集、清洗与增强技术。 | ✅ [视频链接](https://www.bilibili.com/video/BV1FwEizYEWF) |
| ✅ 16 | [PyTorch基础与神经网络构建](../../docs/cn/3/16/README.md) | 掌握Tensor操作与自动求导机制，学习构建并训练基本神经网络模型。 | ⏳ 视频链接 |
| ⏳ 17 | 卷积神经网络与迁移学习 | 理解CNN架构与迁移学习，使用预训练模型进行图像分类实践。 | ⏳ 视频链接 |
| ⏳ 18 | 目标检测与YOLOv8实践 | 掌握目标检测原理，了解YOLO架构并在Jetson平台部署实时检测。 | ⏳ 视频链接 |
| ⏳ 19 | 智能监控系统实现与优化 | 综合应用设计智能监控系统，实现检测、报警、记录与模型优化。 | ⏳ 视频链接 |
